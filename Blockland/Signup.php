...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
  if(register($_POST['CharacterNameIn'],$_POST['PasswordIn'],$_POST['InviteKey'],$_SERVER['REMOTE_ADDR'])){
    //ahhh
    $passwordsql = password_hash($_POST['PasswordIn'],PASSWORD_DEFAULT);
    $stmt = $pdo->prepare("INSERT INTO users (username,password,ip,timestamp) VALUES (?,?,?,NOW())");
    $stmt->execute([$_POST['CharacterNameIn'],$passwordsql,$_SERVER['REMOTE_ADDR']]);
    $user = getuserbyusername($_POST['CharacterNameIn']);
    $_SESSION['id'] = $user['id'];
    $_SESSION['logon'] = true;
    if(newplace($user['id'],'starterplace.rbxl',time())) {
      //webhook('new user joined: '.$user['username'].'');
      if(newbodycolors($user['id'],time())) {
        redirect('/Home.aspx');
      }
    }
  }
...
<div class="aspNetHidden">
  ...
  <input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="XjxqLsUFYohNJ9udYADc4N4OqAh2ZkzQxrtkSt32Q1aqPBpuVl+j9hio4MvMgopbZU3EZrAMUF/2BL4Nj4WnjIlbYtJPJNvhaiEMJtCQM61p+BfyNu0FdcNR8nYPD/uAALteumcNAgoGFRvVRFIUx1OPwM98/uX1/i8pWrTf2q5gdHngD22sAQW20KmbWBSl">
        ...
        <div aria-multiline="False" aria-sort="none">
            ...
            <br>
            <div id="TopBar" class="auto-style34" style="border-color:Black;border-width:1px;border-style:Solid;height:30px;width:733px;margin-left: 506px; margin-top: 0px;">
  
                <div id="Bluesteelpart" class="auto-style12" style="background-color:LightSteelBlue;height:30px;">
                ...
                <div id="Panel3" style="height:205px;width:786px;">
                    ...
                    <span id="Label3" style="font-size: bold">Please do not use your roblox password     </span>
                    <br>
                    ...
                    <br>
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <span id="InviteKeyLbl" style="font-family: 'Comic Sans MS'; font-size: small">Invite Key:</span>
                    <input name="InviteKey" type="password" id="InviteKey" class="auto-style8" style="width:176px;margin-left: 5px; ">
                    <br>
                    <input type="submit" name="SignUpBtn" value="Signup" id="SignUpBtn" class="auto-style13" style="height:21px;width:51px;font-family: Arial, Helvetica, sans-serif; font-size: small; ">
                    <br>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
